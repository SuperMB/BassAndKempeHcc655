...
namespace HccCoffeeMaker.Controllers
{
    public class TestModelsController : Controller
    {
        ...
        public TestModelsController(MyDatabaseContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var testModel = await _context.TestModels.SingleOrDefaultAsync(m => m.ID == id);
            if (testModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,CatName,Height")] TestModel testModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CatName,Height")] TestModel testModel)
        {
            if (id != testModel.ID)
            {
                return NotFound();
